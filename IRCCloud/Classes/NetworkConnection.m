        ...
        if([object.type isEqualToString:@"header"]) {
            ...
            if(!backlog)
                [self postObject:object forEvent:kIRCEventStatusChanged];
                  ...
                  || [object.type isEqualToString:@"server_n_global"] || [object.type isEqualToString:@"motd_response"] || [object.type isEqualToString:@"server_luserunknown"] || [object.type isEqualToString:@"socket_closed"] || [object.type isEqualToString:@"channel_mode_list_change"] || [object.type isEqualToString:@"msg_services"] || [object.type isEqualToString:@"endofstats"] || [object.type isEqualToString:@"sasl_success"] ||
                  [object.type isEqualToString:@"btn_metadata_set"] || [object.type isEqualToString:@"logged_in_as"] || [object.type isEqualToString:@"cap_ls"] || [object.type isEqualToString:@"cap_req"] || [object.type isEqualToString:@"cap_ack"]
