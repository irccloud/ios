...
-(id)initWithJSONObject:(IRCCloudJSONObject*)object {
    ...
    if (self) {
        ...
        [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ (%@@%@%@)", [object objectForKey:@"user_realname"], [object objectForKey:@"user_username"], [object objectForKey:@"user_host"], actualHost] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        
        if([[object objectForKey:@"user_logged_in_as"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@" is authed as %@", [object objectForKey:@"user_logged_in_as"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        [data appendAttributedString:[ColorFormatter format:@"\n" defaultColor:[UIColor blackColor] mono:NO linkify:NO server:nil links:nil query:nil]];
        ...
        if([object objectForKey:@"away"]) {
            ...
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@\n", away] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"signon_time"] intValue]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"Online for about %@", [self duration:([[NSDate date] timeIntervalSince1970] - [[object objectForKey:@"signon_time"] doubleValue])]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];

            if([[object objectForKey:@"idle_secs"] intValue]) {
                [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@" (idle for %@)", [self duration:[[object objectForKey:@"idle_secs"] intValue]]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
            }
        ...
        if([[object objectForKey:@"op_nick"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"op_nick"], [object objectForKey:@"op_msg"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"opername"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"opername"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"userip"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"userip"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"bot_msg"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"bot_msg"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ is connected via: %@", [object objectForKey:@"nick"], [object objectForKey:@"server_addr"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];

        if([[object objectForKey:@"server_extra"] length]) {
            [data appendAttributedString:[ColorFormatter format:@" (" defaultColor:[UIColor blackColor] mono:NO linkify:NO server:nil links:nil query:nil]];
            NSUInteger offset = data.length;
            [data appendAttributedString:[ColorFormatter format:[object objectForKey:@"server_extra"] defaultColor:[UIColor blackColor] mono:NO linkify:YES server:s links:&matches query:nil]];
            [data appendAttributedString:[ColorFormatter format:@")" defaultColor:[UIColor blackColor] mono:NO linkify:NO server:nil links:nil query:nil]];
        ...
        if([[object objectForKey:@"host"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"host"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        ...
        if([[object objectForKey:@"secure"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"secure"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"client_cert"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"client_cert"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"cgi"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"cgi"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"help"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"help"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"vworld"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"vworld"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"modes"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"modes"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
        
        if([[object objectForKey:@"stats_dline"] length]) {
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ %@\n", [object objectForKey:@"nick"], [object objectForKey:@"stats_dline"]] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:s links:nil query:nil]];
        }
...
-(void)addChannels:(NSArray *)channels forGroup:(NSString *)group attributedString:(NSMutableAttributedString *)data links:(NSMutableArray *)links server:(Server *)s {
    NSArray *matches;
    if(channels.count) {
        [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@"%@ of:\n", group] defaultColor:[UIColor blackColor] mono:NO linkify:NO server:nil links:nil query:nil]];
        for(NSString *channel in channels) {
            NSUInteger offset = data.length;
            [data appendAttributedString:[ColorFormatter format:[NSString stringWithFormat:@" • %@\n", channel] defaultColor:[UIColor blackColor] mono:NO linkify:YES server:s links:&matches query:nil]];
            for(NSTextCheckingResult *result in matches) {
                NSURL *u;
                if(result.resultType == NSTextCheckingTypeLink) {
                    u = result.URL;
